...
namespace View
{
    public class CallbackContractImplementation : View.ServiceReference2.IGameContractCallback
    {
        ...
        public static implicit operator CallbackContractImplementation(InstanceContext v)
        {
            throw new NotImplementedException();
        }
    }
